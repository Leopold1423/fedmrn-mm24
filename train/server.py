...
if __name__ == "__main__":
    ...
    parser.add_argument("--com_type", type=str, default="fedavg", help="communication type: fedavg/fedsrn")
    parser.add_argument("--noise_type", type=str, default="uniform_0.001", help="gauss/uniform/bernoulli")
    ...
    parser.add_argument("--num_per_round", type=int, default=10, choices=range(2, 300), help="num_per_round") 
    parser.add_argument("--num_client", type=int, default=100, choices=range(2, 300), help="num_client")  
